...
public class Lec88_Merge_Sorted_Array {
  public static void main(String[] args) {
    ...
    new Lec88_Merge_Sorted_Array().merge(new int[] {1, 2, 3, 0, 0, 0}, 3, new int[] {2, 5, 6}, 3);
    new Lec88_Merge_Sorted_Array().merge(new int[] {1}, 1, new int[] {}, 0);
    new Lec88_Merge_Sorted_Array().merge(new int[] {0}, 0, new int[] {1}, 1);
    new Lec88_Merge_Sorted_Array().merge(new int[] {6, 0, 0, 0}, 1, new int[] {1, 1, 3}, 3);
  }
