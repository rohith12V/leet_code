...
public class Lec15_3_Sum {
  public static void main(String[] args) throws IOException {
    ...
    System.out.println(
        "Total Time Taken in millis O(N^2*Logn)  " + (endMillis - startMillis) + "ms");
  ...
  private static List<List<Integer>> threeSumO2(int[] nums) {
    ...
    for (int i = 0; i < nums.length; i++) {
      // allow for index 0
      // make sure from the index 1 --> N it goes inside only if it does not match with previous
      // element.
  ...
  private static int[] readFile() throws IOException {
    String file =
        "C:\\Users\\Rohit Reddy\\Documents\\Ds-and-Algo\\src\\Day_3_Binary_Search\\Lec15_3_Sum\\input.txt";
