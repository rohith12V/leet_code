...
public class Lec35_Search_Insert_Positions {
  public static void main(String[] args) {
    int result = new Lec35_Search_Insert_Positions().searchInsert(new int[] {}, 10);
  ...
  private int searchInsertUtil(int[] nums, int low, int high, int target) {
    ...
    // return current low pointer because this is where BST could not find the target and expected
    // to be present at this index
    return low;
  }
}
