...
/**
 * This Method is used to find a point in the array where we find non-increasing sequence ( rotated
 * point ) eg : 4,5,6,7,0,1,2 [ pivot_point = 3 ] [ index 0 -> 3 is sorted and index 4 -> 6 is
 * sorted ] By using this pivot point we will come to know that start -> pivot will be sorted and
 * pivot + 1 -> end will be sorted BST ( start , pivot ) BST ( pivot + 1, end )
 */
